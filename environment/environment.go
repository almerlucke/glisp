...
func New() *Environment {
	...
	env.AddGlobalBinding(globals.QuoteSymbol, builtin.CreateBuildinQuote())
	env.AddGlobalBinding(globals.BackquoteSymbol, builtin.CreateBuildinBackquote())
	env.AddGlobalBinding(globals.UnquoteSymbol, builtin.CreateBuildinUnquote())
	env.AddGlobalBinding(globals.SpliceSymbol, builtin.CreateBuildinUnquote())

	env.AddGlobalBinding(glispNS.DefineSymbol("LIST", true, nil, true), builtin.CreateBuildinList())
	env.AddGlobalBinding(glispNS.DefineSymbol("CDR", true, nil, true), builtin.CreateBuildinCdr())
	env.AddGlobalBinding(glispNS.DefineSymbol("CAR", true, nil, true), builtin.CreateBuildinCar())
	env.AddGlobalBinding(glispNS.DefineSymbol("CONS", true, nil, true), builtin.CreateBuildinCons())
	env.AddGlobalBinding(glispNS.DefineSymbol("LAMBDA", true, nil, true), builtin.CreateBuildinLambda())
	env.AddGlobalBinding(glispNS.DefineSymbol("MACRO", true, nil, true), builtin.CreateBuildinMacro())
	env.AddGlobalBinding(glispNS.DefineSymbol("GENSYM", true, nil, true), builtin.CreateBuildinGensym())
	env.AddGlobalBinding(glispNS.DefineSymbol("PRINT", true, nil, true), builtin.CreateBuildinPrint())
	env.AddGlobalBinding(glispNS.DefineSymbol("EXIT", true, nil, true), builtin.CreateBuildinExit())
	env.AddGlobalBinding(glispNS.DefineSymbol("RETURN", true, nil, true), builtin.CreateBuildinReturn())
	env.AddGlobalBinding(glispNS.DefineSymbol("LOAD", true, nil, true), builtin.CreateBuildinLoad())
	env.AddGlobalBinding(glispNS.DefineSymbol("VAR", true, nil, true), builtin.CreateBuildinVar())
	env.AddGlobalBinding(glispNS.DefineSymbol("=", true, nil, true), builtin.CreateBuildinAssign())
	env.AddGlobalBinding(glispNS.DefineSymbol("SCOPE", true, nil, true), builtin.CreateBuildinScope())
	env.AddGlobalBinding(glispNS.DefineSymbol("EVAL", true, nil, true), builtin.CreateBuildinEval())
	env.AddGlobalBinding(glispNS.DefineSymbol("ELT", true, nil, true), builtin.CreateBuildinElt())
	env.AddGlobalBinding(glispNS.DefineSymbol("ARRAY", true, nil, true), builtin.CreateBuildinArray())
	env.AddGlobalBinding(glispNS.DefineSymbol("MAKE-ARRAY", true, nil, true), builtin.CreateBuildinMakeArray())
	env.AddGlobalBinding(glispNS.DefineSymbol("IF", true, nil, true), builtin.CreateBuildinIf())
	env.AddGlobalBinding(glispNS.DefineSymbol("PROGN", true, nil, true), builtin.CreateBuildinProgn())
	env.AddGlobalBinding(glispNS.DefineSymbol("TRY", true, nil, true), builtin.CreateBuildinTry())
	env.AddGlobalBinding(glispNS.DefineSymbol("THROW", true, nil, true), builtin.CreateBuildinThrow())
	env.AddGlobalBinding(glispNS.DefineSymbol("DICTIONARY", true, nil, true), builtin.CreateBuildinDictionary())
	env.AddGlobalBinding(glispNS.DefineSymbol("AND", true, nil, true), builtin.CreateBuildinAnd())
	env.AddGlobalBinding(glispNS.DefineSymbol("OR", true, nil, true), builtin.CreateBuildinOr())
	env.AddGlobalBinding(glispNS.DefineSymbol("NOT", true, nil, true), builtin.CreateBuildinNot())
	env.AddGlobalBinding(glispNS.DefineSymbol("NAMESPACE", true, nil, true), builtin.CreateBuildinNamespace())
	env.AddGlobalBinding(glispNS.DefineSymbol("IN-NAMESPACE", true, nil, true), builtin.CreateBuildinInNamespace())
	env.AddGlobalBinding(glispNS.DefineSymbol("USE-NAMESPACE", true, nil, true), builtin.CreateBuildinUseNamespace())
